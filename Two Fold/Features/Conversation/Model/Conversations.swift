...
var conversations: [Conversations] = [
    ...
    Conversations(teamName: "Anabelle & Keren", lastMsg: "Oh my🤯, you look so tall. Do you play basketball or something?", lastMsgTimeSent: Date.now, numberUnreadMsgs: 0, profilePicture: "Team 2"),
